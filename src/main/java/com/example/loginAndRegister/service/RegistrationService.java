...
import com.example.loginAndRegister.model.AppUserRole;
...
public class RegistrationService {
    ...
    public RegistrationService(UserService user, EmailValidator emailValidator, ConfirmationTokenService confirmationTokenService, EmailSender emailSender) {
        this.user = user;
    ...
    public String register(RegistrationRequestDTO requestDTO) {
        ...
        String token = user.signUpUser(new AppUser(
    ...
    public String confirmToken(String token) {
        ...
        user.enableUser(confirmationToken.getUser().getUsername());
